# Рогулайк игра. Версия 003. (23.04.2022)
# Изменена часть переменных на глобальные (23.04.2022)
# Панель характеристик персонажа отделена в метод (23.04.2022)
# (23.04.2022)
...
def character_panel
  ...
  puts "Н А В Ы К И:"
  puts "[акт] #{@name_special_pl} #{@lor_secial_pl}"
...
when 'S'
  ...
  @lor_secial_pl = "(#{lvl_special_pl}): урон сильнее в #{special_damage_pl}, наносится по телу. Цена 15 выносливости"
when 'A'
  ...
  @lor_secial_pl = "(#{lvl_special_pl}): точнее в #{special_accuracy_pl}, сильнее в #{special_damage_pl} наносится по телу. Цена 5 выносливости"
end
...
while true
  ...
  while points != 0
    ...
    # Заплатка 1 для корректного отображения навыков на которые влияют характеристики ..............................
    ...
    character_panel # Панель характеристик персонажа
  ...
  while skil_points != 0
    ...
    # Заплатка 2 для корректного отображения навыков на которые влияют характеристики ..............................
    if @name_passive_pl == "Концентрация"
      damage_passive_pl = rand(0..0.1 * (@max_mp_pl * (1 + 0.05 * lvl_passive_pl) - 100))
      @lor_passive_pl = "(#{lvl_passive_pl}): если мана больше 100(#{@max_mp_pl}) наносится случайный доп урон до #{(0.1 * (@max_mp_pl * (1 + 0.05 * lvl_passive_pl) - 100)).round(1)}"
    end
    ...
    while distribution != 'S' and distribution != 'P' and distribution != 'N'
      ...
      when 'S' # активные
        ...
        if @name_special_pl == "Сильный удар"
          special_damage_pl = 2 + 0.2 * lvl_special_pl
          @lor_secial_pl = "(#{lvl_special_pl}): урон сильнее в #{special_damage_pl.round(1)}, наносится по телу. Цена 15 выносливости"
  ...
  # Заплатка 3 для корректного отображения навыков на которые влияют характеристики ..............................
  if @name_passive_pl == "Концентрация"
    damage_passive_pl = rand(0..0.1 * (@max_mp_pl * (1 + 0.05 * lvl_passive_pl) - 100))
    @lor_passive_pl = "(#{lvl_passive_pl}): если мана больше 100(#{@max_mp_pl}) наносится случайный доп урон до #{(0.1 * (@max_mp_pl * (1 + 0.05 * lvl_passive_pl) - 100)).round(1)}"
  end
